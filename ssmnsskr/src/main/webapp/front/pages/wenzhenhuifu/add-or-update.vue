<template>
	<view class="content">
		<form class="app-update-pv">
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(21, 20, 20, 1)","textAlign":"left"}' class="title">答复时间</view>
				<picker mode="date" :value="ruleForm.dafushijian" @change="dafushijianChange">
					<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(20, 19, 19, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.dafushijian?ruleForm.dafushijian:"请选择答复时间"}}</view>
				</picker>
			</view>
			...
			<!-- 否 -->
				...
				<textarea :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 22, 22, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.wenzhenneirong" placeholder="问诊内容"></textarea>
						          				...
						          				<view :style='{"boxShadow":"","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"#ccc","margin":"","borderWidth":"0","borderStyle":"solid","height":"308rpx"}' class="cu-form-group">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(28, 27, 27, 1)","textAlign":"left"}' class="title">问诊答复</view>
				<textarea :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 22, 22, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.wenzhendafu" placeholder="问诊答复"></textarea>
			</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
    		        this.ruleForm.dafushijian = this.$utils.getCurDate();
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='wenzhendafu'){
					this.ruleForm.wenzhendafu = obj[o];
					this.ro.wenzhendafu = true;
					continue;
					}
					if(o=='dafushijian'){
					this.ruleForm.dafushijian = obj[o];
					this.ro.dafushijian = true;
					continue;
					}
					if(o=='tupian'){
		...
		methods: {
			...
			// 多级联动参数
																																							...
																																							dafushijianChange(e) {
				this.ruleForm.dafushijian = e.target.value;
				this.$forceUpdate();
			},
