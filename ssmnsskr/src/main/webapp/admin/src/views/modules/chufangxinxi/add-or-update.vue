<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="治疗周期" prop="zhiliaozhouqi">
          <el-input v-model="ruleForm.zhiliaozhouqi" 
              placeholder="治疗周期" clearable  :readonly="ro.zhiliaozhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="治疗周期" prop="zhiliaozhouqi">
              <el-input v-model="ruleForm.zhiliaozhouqi" 
                placeholder="治疗周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病情解析" prop="bingqingjiexi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="病情解析"
                  v-model="ruleForm.bingqingjiexi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bingqingjiexi" label="病情解析" prop="bingqingjiexi">
                    <span>{{ruleForm.bingqingjiexi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处方单" prop="chufangdan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.chufangdan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chufangdan" label="处方单" prop="chufangdan">
                    <span v-html="ruleForm.chufangdan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.chufangdan = this.ruleForm.chufangdan.replace(reg,'../../../ssmnsskr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
