    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="就诊卡号" prop="jiuzhenkahao">
          <el-input v-model="ruleForm.jiuzhenkahao" 
              placeholder="就诊卡号" clearable  :readonly="ro.jiuzhenkahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="就诊卡号" prop="jiuzhenkahao">
              <el-input v-model="ruleForm.jiuzhenkahao" 
                placeholder="就诊卡号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病症描述" prop="bingzhengmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="病症描述"
                  v-model="ruleForm.bingzhengmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bingzhengmiaoshu" label="病症描述" prop="bingzhengmiaoshu">
                    <span>{{ruleForm.bingzhengmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="治疗情况" prop="zhiliaoqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="治疗情况"
                  v-model="ruleForm.zhiliaoqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhiliaoqingkuang" label="治疗情况" prop="zhiliaoqingkuang">
                    <span>{{ruleForm.zhiliaoqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="就诊记录" prop="jiuzhenjilu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiuzhenjilu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiuzhenjilu" label="就诊记录" prop="jiuzhenjilu">
                    <span v-html="ruleForm.jiuzhenjilu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiuzhenkahao!=''&&json.jiuzhenkahao){
	...
	this.ruleForm.jiuzhenjilu = this.ruleForm.jiuzhenjilu.replace(reg,'../../../ssmnsskr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huanzhexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huanzhexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
