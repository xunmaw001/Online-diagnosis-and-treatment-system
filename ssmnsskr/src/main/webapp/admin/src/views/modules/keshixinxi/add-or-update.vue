    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="医生介绍" prop="yishengjieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yishengjieshao" label="医生介绍" prop="yishengjieshao">
                    <span>{{ruleForm.yishengjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.paibanbiao = this.ruleForm.paibanbiao.replace(reg,'../../../ssmnsskr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
