<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="就诊卡号" prop="jiuzhenkahao">
          <el-input v-model="ruleForm.jiuzhenkahao" readonly              placeholder="就诊卡号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="职位" prop="zhiwei">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='yisheng'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tupian?ruleForm.tupian:''"
          @change="yishengtupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    yishengtupianUploadChange(fileUrls) {
        this.ruleForm.tupian = fileUrls;
    },
    onUpdateHandler() {
      if((!this.ruleForm.jiuzhenkahao)&& 'yonghu'==this.flag){
