  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">远程在线诊疗系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiuzhenkahao" class="input" type="text" placeholder="就诊卡号">
			   </div>
			 </div> -->
			<el-form-item label="就诊卡号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiuzhenkahao" autocomplete="off" placeholder="就诊卡号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
